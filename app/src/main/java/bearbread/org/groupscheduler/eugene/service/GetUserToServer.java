...
/**
 * Created by Eugene J. Jeon on 2015-06-01.
 */
public class GetUserToServer extends AsyncTask<Void, Void, ArrayList<HashMap<String, String>>> {
    private final String URL = "http://www.dcafe.xyz:8912/";
    private final String TAG = "GetUserToServer";

    private Context mContext;
    private ProgressDialog mDialog;

    public GetUserToServer(Context context) {
        mContext = context;
    }
    ...
    // Background 작업 진행
    @Override
    protected ArrayList<HashMap<String, String>> doInBackground(Void... vois) {
        ArrayList<HashMap<String, String>> result = new ArrayList<>();
        String value = "";

        try {
            HttpPost request = new HttpPost(URL + "GET_USER");
